...
void loadGameInfo(void)
{
  ...
  for (i=0; i < totalGames; i++) {
    ...
    infoPanel[i].titleText = TTF_RenderText_Blended(titleFont, currentNode->gameTitle, itemTextColor);
...
fprintf(stderr, "Image: '%s'\n", tempBuf);
    ...
    infoPanel[i].genreText = TTF_RenderText_Blended(textFont, tempBuf, itemTextColor);
    infoPanel[i].dateText = TTF_RenderText_Blended(textFont, currentNode->dateText, itemTextColor);
    ...
    if (!currentNode->infoText[0][0] && !currentNode->infoText[1][0] &&
      ...
      infoPanel[i].itemText[0] = TTF_RenderText_Blended(textFont, "No description available.", itemTextColor);
    else
      infoPanel[i].itemText[0] = TTF_RenderText_Blended(textFont, currentNode->infoText[0], itemTextColor);
    infoPanel[i].itemText[1] = TTF_RenderText_Blended(textFont, currentNode->infoText[1], itemTextColor);
    infoPanel[i].itemText[2] = TTF_RenderText_Blended(textFont, currentNode->infoText[2], itemTextColor);
    infoPanel[i].itemText[3] = TTF_RenderText_Blended(textFont, currentNode->infoText[3], itemTextColor);
    infoPanel[i].itemText[4] = TTF_RenderText_Blended(textFont, currentNode->infoText[4], itemTextColor);
  }
}
