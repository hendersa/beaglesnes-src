...
void S9xExit (void)
{
	...
	Memory.SaveSRAM(S9xGetFilename(".srm", SRAM_DIR));
	// AWH S9xSaveCheatFile(S9xGetFilename(".cht", CHEAT_DIR));
...
fprintf(stderr, "AWH: ROM: '%s'\n", s);
	...
	// AWH S9xLoadCheatFile(S9xGetFilename(".cht", CHEAT_DIR));
