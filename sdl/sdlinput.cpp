...
// AWH - These were 6 and 7, rather than 4 and 5, for Tommee
...
// AWH - This was 11, rather than 9, for Tommee
    ...
    keymaps.push_back(strpair_t("J01:B9",        "Joypad2 Start"));
#else
...
/***** Joystick starts *****/
		...
		case SDL_JOYBUTTONUP:
			S9xReportButton(0x80000000 | // joystick button
					(beagleSNESDeviceMap[event.jbutton.which] << 24) | // joystick index
		...
		case SDL_JOYAXISMOTION:
			S9xReportAxis(0x80008000 | // joystick axis
				      (beagleSNESDeviceMap[event.jaxis.which] << 24) | // joystick index
